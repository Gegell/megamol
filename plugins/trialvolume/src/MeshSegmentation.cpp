...
bool MeshSegmentation::getSegmentationCallback(core::Call& call) {
    ...
    segmentationCall->SetBaseIndices(meshCall->get_indices());
    segmentationCall->SetBaseNormals(meshCall->get_normals());
    segmentationCall->SetBaseVertices(meshCall->get_vertices());
